    ...
    constructor(props){
       ...
       costCheck(){ //empty field check for cost
        ...
        checkDate(){  //Check: Arrival Date should be less than Departure Date
          const { departure_date , return_date ,empty} = this.state;
        ...
        submitHandler = e =>{
          ...
          if(this.validation() == true){
            console.log('form submited')
              ...
              formData.append("id", this.props.location.state.trip.id)
              formData.append("pic", this.props.location.state.trip.pic)
              formData.append("days", this.Days(e.target.return_date.value,e.target.departure_date.value))
              if(e.target.departure_city.value!='' && e.target.arrival_city.value!='' && e.target.departure_city.value!=e.target.arrival_city.value &&e.target.cost.value!=''&& e.target.details.value!='')
             {
                  axios.post('/trips/edittrip',formData,
  ...
  render() { 
    ...
    return (
        <div className="postPage">
            ...
            <div className="dashBoardHeadings">Edit Tour</div>
            <div className="formData">
              <div className="container">
               <div className="row">
                  <div className="col-sm-6 col-lg-6 col-xl-6">
                  <span className="registerLabel">Departure City</span>
                  <select type="text" className="smallBox" name="departure_city" onChange={this.depCity}  > 
                  <option value={this.props.location.state.trip.departure_city}selected>{this.props.location.state.trip.departure_city}</option>
	             ...
	             <option value="Arang Kel">Arang Kel</option>
                  ...
                  <option value="Ziarat">Ziarat</option>
                    ...
                    <span className="registerLabeli">{this.props.location.state.trip.departure_city}</span>  
                  </div>
                  <div className="col-sm-6 col-lg-6 col-xl-6">
                  ...
                  <option value={this.props.location.state.trip.arrival_city}selected>{this.props.location.state.trip.arrival_city}</option>
                  <option value="Swat">Swat</option> <option value="Islamabad">Islamabad</option>
	             <option value="Naran">Naran</option> 
	             <option value="Skardu">Skardu</option> 
	             <option value="Gilgit">Gilgit</option> 
              ...
              <span className="registerLabeli">{this.props.location.state.trip.arrival_city}</span>
                  </div>
              ...
              <div className="row">
                  <div className="col-sm-6 col-lg-6 col-xl-6">
                    <span className="registerLabel">DepartureDate</span><input type="date" className="smallBox" id="departure" name="departure_date" onChange={this.depDate} Value={new Date(this.props.location.state.trip.departure_date).getFullYear()+'-'+("0" + (new Date(this.props.location.state.trip.departure_date).getMonth() + 1)).slice(-2)+'-'+("0" + new Date(this.props.location.state.trip.departure_date).getDate()).slice(-2)} />
                    <span className="registerLabeli">Re-Enter departure date to confirm</span>
                  </div>
                  <div className="col-sm-6 col-lg-6 col-xl-6">
                    <span className="registerLabel">ReturnDate</span><input type="date" className="smallBox" id="return" name="return_date" onChange={this.retDate} Value={new Date(this.props.location.state.trip.return_date).getFullYear()+'-'+("0" + (new Date(this.props.location.state.trip.return_date).getMonth() + 1)).slice(-2)+'-'+("0" + new Date(this.props.location.state.trip.return_date).getDate()).slice(-2)} />
                    <span className="registerLabeli">Re-Enter return date to confirm</span>
                  </div>
              ...
              <div className="row">
                  ...
                  <span className="registerLabel">Cost</span><input type="number" className="smallBox" name="cost" min="1000" onChange={this.pricing} defaultValue={this.props.location.state.trip.cost} />
                  <span className="registerLabeli">{this.props.location.state.trip.cost}</span>
                  </div>
              </div>
              <div className="line"></div>
              ...
              <div className="row">
                  <div className="col-sm-12 col-lg-12 col-xl-12">
                  <span className="registerLabel">Details</span><textarea type="text" className="smallBox" name="details" onChange={this.detail} defaultValue={this.props.location.state.trip.details} />     
                  </div>
              </div>
               ...
               <div className = "row">
                   ...
                   <div className = "col-sm-12 col-xs-12 col-md-12 col-lg-12 col-xl-4">
                      <button type="submit" className="tourSubmit">Update Tour</button>
                   </div>
               </div>
