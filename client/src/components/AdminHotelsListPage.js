...
class AdminHotelsListPage extends Component {
  constructor() {
    super()
    this.state = {
        Hotels:[],
  ...
  onSubmit(e) {
    ...
    axios.post('/hotels/filter',filter,
    {
  ...
  gethotels(){
    fetch('http://localhost:5000/hotels/filteredhotellist')
...
return (
  ...
  <div className="container">
      ...
      { this.state.Hotels.map(hotels => 
              <div className="col-lg-3 col-xl-4 col-sm-12 col-xs-12 col-md-3">
                <div className="PostAll">
                  <div className="cardHead">
                    <img src={`http://localhost:5000/uploads/`+hotels.pic}  alt=" " />
                  </div>
                  ...
                  <div className="container">
                    <div className="cardBody">
                      ...
                      <p><i class='fas fa-map-marker'></i> {hotels.city}<br />
                      Rs. {hotels.price}<br />
                      <i class='fas fa-phone'></i> {hotels.contact}</p>
