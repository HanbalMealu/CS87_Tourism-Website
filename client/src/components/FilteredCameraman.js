...
class Cameraman extends React.Component {
 constructor() {
  super();
         this.state = {
          cameraman: [],
      ...
      getCameraman(){
        fetch('http://localhost:5000/rentalservices/filteredcameramanlist')
        .then(results=>results.json())
        .then(results=>this.setState({'cameraman':results}))
      }
  ...
  render() {
    ...
    return (
      ...
      <div class="serviceBanner">
        ...
        <div class="serviceBanner1"><p>Services</p></div>
      <div className="filterBox">
          <div className="container">
            ...
            <div className="lineFilter"></div>
              ...
              <div className="col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                <select name="location" className="filterTour" onChange={this.onChange} > 
                ...
                />
                 ...
                 <div className="col-lg-6 col-xl-6 col-sm-12 col-md-12 col-xs-12">
                  <select name="sort" className="filterTour" onChange={this.onChange} > 
                    ...
                    <option value="rentalservices.posted desc">Latest</option>
                    <option value="rentalservices.price">Price: low to high</option>                
                    <option value="rentalservices.price desc">Price: high to low</option>
          ...
          <div className="row">
              ...
              { this.state.cameraman.map(accomodation => 
