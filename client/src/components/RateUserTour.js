...
class RateUserTour extends Component {
  constructor(props) {
    super(props)
    this.state = {
      review:{},
  ...
  onSubmit(e) {
    ...
    const ratingData = {
      ...
      title:this.props.location.state.review.departure_city+' to '+this.props.location.state.review.arrival_city,
