...
submitHandler = e =>{
  e.preventDefault()
   ...
   formData.append("pic", this.props.location.state.Hotel.pic)
   formData.append("pic1", this.props.location.state.Hotel.pic1)
   formData.append("pic2", this.props.location.state.Hotel.pic2)
   formData.append("pic3", this.props.location.state.Hotel.pic3)
   formData.append("pic4", this.props.location.state.Hotel.pic4)
   formData.append("hotel_id", this.props.location.state.Hotel.hotel_id)
    axios.post('/hotels/hoteledit',formData,
        ...
        <div>
            <div className="row">
                ...
                <div className="col-lg-9 col-xl-9">
                              ...
                              <div className="dashBoardHeadings">Edit a Hotel</div>
                          ...
                          <br />
                            ...
                            <div className="row">
                              ...
                              <span className="registerLabel">Hotel Name</span>
                                <input type="text" className="smallBox" onChange={this.title} minLength="6" name="title" defaultValue={this.props.location.state.Hotel.name} />
                              </div>
                            </div>
                            <br />
                        <div className="row">
                          ...
                          <span className="registerLabel">Location</span>
                            <select name="location" className="smallBox" onChange={this.Location}> 
                              <option value={this.props.location.state.Hotel.city} selected>{this.props.location.state.Hotel.city}</option>
	             ...
	             <option value="Arang Kel">Arang Kel</option>
                          ...
                          <span className="registerLabel">Starting Price</span>
                            <input type="number" min="1000" className="smallBox" onChange={this.Price} name="price" defaultValue={this.props.location.state.Hotel.price} />
                          </div>
                        </div>
                        <br />
                        <div className="row">
                          ...
                          <span className="registerLabel">Hotel contact</span>
                            <input type="text" className="smallBox" name="contact" defaultValue={this.props.location.state.Hotel.contact}  onChange={this.onChange}/>
                          </div>
                        </div>
                       <br />
                        <div className="row">
                          ...
                          <span className="registerLabel">Hotel Details</span>
                            <textarea type="text" className="smallBox" name="details" defaultValue={this.props.location.state.Hotel.details} onChange={this.Detail}/>
                          </div>
                        </div>
                        <br />
                        ...
                        <div className="row">
                          ...
                          <br />
                                <div className="row">
                                    <div className="col-sm-12 col-lg-6 col-xl-6"></div>
                                    <div className="col-sm-12 col-lg-3 col-xl-3">
                                      <button type="submit" className="tourSubmit">Update</button>
                                    </div>
                                    <div className="col-sm-12 col-lg-3 col-xl-3">
