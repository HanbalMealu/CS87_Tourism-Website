...
class EditService extends Component {
    constructor(props){
      ...
      submitHandler = e =>{
        e.preventDefault()
        if(e.target.title.value!=''&&e.target.price.value!=''&&e.target.location.value!=''&&e.target.details.value!=''){
            ...
            formData.append("id", this.props.location.state.services.id)
            formData.append("pic", this.props.location.state.services.pic)
            formData.append("pic1", this.props.location.state.services.pic1)
            formData.append("pic2", this.props.location.state.services.pic2)
            formData.append("pic3", this.props.location.state.services.pic3)
            formData.append("pic4", this.props.location.state.services.pic4)
          axios.post('/rentalservices/update',formData,
      ...
      render() { 
        return (
            <div className="postPage">
              ...
              <div className="dashBoardHeadings">Edit Service</div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                      ...
                      <span className="registerLabel">Title</span>
                        <input type="text" className="smallBox" onChange={this.title} minLength="10" name="title" defaultValue={this.props.location.state.services.title}/>
                      </div>
                    </div>
                ...
                <div className="row">
                  <div className="col-sm-12 col-lg-6 col-xl-6">
                   <span className="registerLabel">Location</span>
                    <select name="location" className="smallBox" onChange={this.Location}> 
                      <option value={this.props.location.state.services.location}selected>{this.props.location.state.services.location}</option>
	             ...
	             <option value="Arang Kel">Arang Kel</option>
                  ...
                  <span className="registerLabel">Price</span>
                    <input type="number" min="1000" className="smallBox" onChange={this.Price} name="price" defaultValue={this.props.location.state.services.price} />
                  </div>
                </div>
                <div className="line"></div>
                ...
                <div className="row">
                  ...
                  <span className="registerLabel">Details</span>
                    <textarea type="text" className="smallBox" name="details" defaultValue={this.props.location.state.services.details} onChange={this.Detail}/>
                  </div>
                </div>
                <div className="line"></div>
                <div className="row">
